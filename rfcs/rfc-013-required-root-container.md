...
No record, relation, type, or field definition changes. The `srs/srs` spec repository itself must gain a conforming root container as part of Stage 6 authoring (it is a repository and is subject to R1).
