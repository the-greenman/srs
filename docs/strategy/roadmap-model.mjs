...
// The Pattern Grid's twelve cells (rfc-decision-cce3c00e / docs/charter/decision-compass.md).
// A standardContracts entry for a dormancy-rule removal names its cell here; the field is
// optional (pre-charter contracts carry none) but must not silently drift from the grid.
export const PATTERN_GRID_CELLS = new Set(["Versioning", "Identity", "Description", "Attribution", "Succession", "Containment", "Reference", "Assertion", "Governance", "Repository", "Conformance", "Portability"]);
