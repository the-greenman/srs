...
const FIELD_SPECS = [
  ...
  [19, 'value_domain', closed(['open', 'closed']), 'Whether a string or integer field is open or bound to a closed set of values. datatype == string or integer only (RFC-032 [R3], widened by srs#534).'],
...
const TYPE_SPECS = {
  ...
  'field-type': {
    ...
    assignments: [
      ...
      a('value_domain', false, 'Value Domain', 'datatype == string or integer only (R3, widened by srs#534). Default: open. When closed, exactly one of allowedValues or vocabularyRef is present.'),
